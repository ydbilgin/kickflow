...
export const messages = {
  ...
  'modaction.ban.single': { en: '{name} was banned', tr: '{name} banlandı' },
  'modaction.ban.bulk': { en: '{n} bans:', tr: '{n} ban:' },
  'modaction.timeout.single': { en: '{name} was timed out', tr: '{name} için zaman aşımı uygulandı' },
  'modaction.timeout.bulk': { en: '{n} timeouts:', tr: '{n} zaman aşımı:' },
  'modaction.delete.single': { en: "{name}'s message was deleted", tr: '{name} kullanıcısının mesajı silindi' },
  'modaction.delete.bulk': { en: '{n} messages were deleted:', tr: '{n} mesaj silindi:' },
